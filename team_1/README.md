...
- [`docs/`](docs/): Folder containing documentation for the analysis, including the [presentation output](docs/Presentation_June_9th.pdf) and a knitted pdf version of the [code and documentation](docs/Researchsprint_code.pdf). This folder is the core output of our Sprint results.
- [`Researchsprint_code.Rmd`](Researchsprint_code.Rmd): R Markdown file with the R code and documentation of the analysis that can be used to replicate all feature engineering, figures and regression results.
